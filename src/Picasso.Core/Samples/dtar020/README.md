...
Three real gaps surfaced that no synthetic copybook had, because synthetic copybooks don't have these problems by construction. The first is now fixed; two remain.
...
Gaps 2 and 3 remain open — see the main [README](../../../../README.md)'s "Not supported (v1)" section.
